...
> **Prefer property-based tests for invariants; add example-based tests only where necessary.**
...
- [ ] TXXX [P] Additional property-based tests for cross-story invariants in tests/
...
- Property-based tests SHOULD be authored before example-based tests when invariants exist
